...
public class ModelCreator {
    ...
    public void create(ResultSetMetaData meta) throws SQLException
    {
        ...
        for (int i = 1; i <= count; i++)
        {
            ...
            System.out.println(String.format("%s - %s", columnClassName, columnName));
            ...
            sb.append("    private ").append(GenerateHelper.getJavaType(columnClassName)).append(" ").append(columnName).append(";\r\n");
        }
        System.out.println("__________________________________________________________");
        //生成setter, getter
        for (int i = 1; i <= count; i++)
        {
            ...
            sb.append(GenerateHelper.getJavaType(columnClassName)).append(" ").append(columnName).append(") {\r\n");
            //            sb.append("        this.").append(hasserName).append(" = Boolean.TRUE;\r\n");
            sb.append("        this.").append(columnName).append(" = ").append(columnName).append(";\r\n");
            sb.append("    }\r\n");

            sb.append("\r\n");

            sb.append("    public ").append(GenerateHelper.getJavaType(columnClassName)).append(" ").append(getterName).append("() {\r\n");
        ...
        //            String hasserName = "has" + StringUtil.first2UpperCase(columnName);
        //
        //            sb.append("    private Boolean ").append(hasserName).append(";\r\n");
        //        }
        //
        //        //生成辅助字段的has方法
        //        for (int i = 1; i <= count; i++) {
        ...
        //            String hasserName = "has" + StringUtil.first2UpperCase(columnName);
        //
        //            sb.append("    public Boolean ").append(hasserName).append("(){\r\n");
        //            sb.append("        return this.").append(hasserName).append(" != null;\r\n");
        //            sb.append("    }\r\n");
        //        }
        //
        //        //生成clear方法
        ...
        //            columnName = GenerateHelper.getColumnName(columnName);
        //            String hasserName = "has" + StringUtil.first2UpperCase(columnName);
        //            String clearName = "clear" + StringUtil.first2UpperCase(columnName);
        //
        //            sb.append("    public void ").append(clearName).append("(){\r\n");
        //            sb.append("        this.").append(columnName).append(" = null;\r\n");
        //            sb.append("        this.").append(hasserName).append(" = Boolean.FALSE;\r\n");
        //            sb.append("    }\r\n");
        //        }
        ...
        for (int i = 1; i <= count; i++)
        {
            String columnName = meta.getColumnName(i);
            columnName = GenerateHelper.getColumnName(columnName);
            sb.append("        result = prime * result + ((" + columnName + " == null) ? 0 : " + columnName + ".hashCode());\r\n");
        }
