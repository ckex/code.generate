...
public class TestCaseFileCreator {
    ...
    public void create(String table, ResultSetMetaData meta) throws SQLException
    {
        ...
        sb.append(" */").append("\r\n");
        sb.append("public class " + className + "ImplTest");
        //        sb.append(" extends AbstractWangjubaoTest "); //TODO ...
        sb.append(" {\r\n");
        ...
        sb.append("        // common.page.util.PageQuery pageQuery = new common.page.util.PageQuery(0,10);\r\n");
        sb.append("        // Integer count = null;\r\n");
        sb.append("        // common.page.util.PageList<").append(modelClassName)
                .append("> result = ");
