...
public class ObjectUtil {
     ...
     * </pre>
     * 
     * @param buffer <code>StringBuffer</code>���������<code>null</code>
     *            ���򴴽��µ�
     * @param object ����
    ...
    public static Object clone(Object array) {
        ...
        if (!(array instanceof Cloneable)) {
            throw new UnsupportedOperationException("Object of class " + array.getClass().getName()
                    + " is not Cloneable");
        }
