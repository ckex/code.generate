...
public class ClassUtil {
     ...
     * ȡ��ֱ�۵�����
     * <p>
     * �൱�� <code>clazz.getName()</code> ������ͬ���ǣ��÷����ø�ֱ�۵ķ�ʽ��ʾ�������͡�
     * ���磺
     * 
     * <pre>
     *  int[].class.getName() = "[I" ClassUtil.getClassName(int[].class) = "int[]"
     ...
     * 
     * @param clazz Ҫ��ʾ�������
     * @return ������ʾ��ֱ���������ԭʼ��Ϊ <code>null</code> ���򷵻�
     *         <code>null</code>
     */
     ...
     * 
     * @param className Ҫ��ʾ������
     * @return ������ʾ��ֱ���������ԭ����Ϊ <code>null</code> ���򷵻�
     *         <code>null</code> �����ԭ�����ǷǷ��ģ��򷵻�ԭ����
     */
     ...
     * 
     * @param className ����
     * @param processInnerClass �Ƿ�������ָ��� <code>'$'</code> ת����
     *            <code>'.'</code>
     ...
     * @return ���ά��Ϊ0, �򷵻ػ��౾��, ���򷵻������࣬�������Ļ���Ϊ <code>null</code>
     *         ���򷵻� <code>null</code>
     */
     ...
     * 
     * @param clazz Ҫ���ҵ���
     * @return �����ά��. ���������, �򷵻� <code>0</code> ���������Ϊ
     *         <code>null</code> ���Ƿ��� <code>-1</code>
     */
     ...
     * <p>
     * ����һ�� <code>Class</code>
     * ʵ��������ǽӿڣ�Ҳ�������飬�˷��������г��Ӹ���ĸ��࿪ʼֱ�� <code>Object</code>
     * �������ࡣ
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * ����<code>ClassUtil.getSuperclasses(java.util.List.class)</code>
     * ������һ�����б?
     * </p>
     * <p>
    ...
    /**
     * ���һ��ָ������ <code>fromClasses</code> �Ķ����Ƿ���Ը�ֵ����һ������
     * <code>classes</code>��
     * <p>
     * �˷�����������ȷ��ָ�����͵Ĳ��� <code>object1, object2, ...</code>
     * �Ƿ������������ȷ����������Ϊ <code>class1, class2,
     * ...</code> �ķ�����
     * </p>
     * <p>
     ...
     * <code>clazz</code> Ϊ��ԭ�����ͣ��򷵻� <code>true</code>�� ��Ϊ
     * <code>null</code> ���Ա������κ��������͡�</li>
     * <li>���� <code>Class.isAssignableFrom</code> ������ȷ��Ŀ����
     * <code>clazz</code> �Ƿ�Ͳ����� <code>fromClass</code>
     * ��ͬ�����丸�ࡢ�ӿڣ�����ǣ��򷵻� <code>true</code>��</li>
     ...
     * Conversion���򣬲������� <code>fromClass</code>
     * �������κ�����չ�ɸ�Ŀ�����͵�ԭ�����ͼ����װ�ࡣ ���磬 <code>clazz</code> Ϊ
     * <code>long</code> ����ô�������Ϳ����� <code>byte</code>��
     * <code>short</code>��<code>int</code>��<code>long</code>��
     * <code>char</code> �����װ�� <code>java.lang.Byte</code>��
     ...
     * </p>
     * 
     * @param classes Ŀ�������б?����� <code>null</code> ���Ƿ���
     *            <code>false</code>
    ...
    /**
     * ���ָ������ <code>fromClass</code> �Ķ����Ƿ���Ը�ֵ����һ������
     * <code>clazz</code>��
     * <p>
     * �˷�����������ȷ��ָ�����͵Ĳ��� <code>object1, object2, ...</code>
     * �Ƿ������������ȷ���������� <code>class1, class2,
     * ...</code> �ķ�����
     * </p>
     * <p>
     * �������¹���
     ...
     * 
     * @param clazz Ҫ��������
     * @return ���ָ������Ϊ<code>null</code>����primitive���͵İ�װ�࣬�򷵻�
     *         <code>null</code>�����򷵻���Ӧ��primitive���͡�
     */
