...
public class StringUtil {
     ...
     * @return ��һ��ƥ�������ֵ������ַ�Ϊ<code>null</code>��δ�ҵ����򷵻�
     *         <code>-1</code>
     */
    ...
    /**
     * ���ַ��в���ָ���ַ����е��ַ������ص�һ��ƥ�����ʼ���� ����ַ�Ϊ<code>null</code>
     * ���򷵻�<code>-1</code>�� ����ַ���Ϊ<code>null</code>��գ�Ҳ����
     * <code>-1</code>�� ����ַ��ϰ���<code>""</code>�������ַ�Ϊ<code>null</code>
     * ���򷵻�<code>str.length()</code>
     *
     * <pre>
     * StringUtil.indexOfAny(null, *)                     = -1
     * StringUtil.indexOfAny(*, null)                     = -1
    ...
    /**
     * ���ַ��в��Ҳ���ָ���ַ���е��ַ����ص�һ��ƥ�����ʼ���� ����ַ�Ϊ<code>null</code>
     * ���򷵻�<code>-1</code>�� ����ַ��Ϊ<code>null</code>��գ�Ҳ����<code>-1</code>
     * ��
     *
     * <pre>
    ...
    /**
     * ���ַ�β����ʼ����ָ���ַ����ص�һ��ƥ�������ֵ������ַ�Ϊ<code>null</code>
     * ��δ�ҵ����򷵻�<code>-1</code>��
     *
     * <pre>
    ...
    /**
     * ���ַ�β����ʼ����ָ���ַ����е��ַ������ص�һ��ƥ�����ʼ���� ����ַ�Ϊ
     * <code>null</code>���򷵻�<code>-1</code>�� ����ַ���Ϊ<code>null</code>
     * ��գ�Ҳ����<code>-1</code>�� ����ַ��ϰ���<code>""</code>�������ַ�Ϊ
     * <code>null</code>���򷵻�<code>str.length()</code>
     *
     * <pre>
     ...
     * <code>null</code>�򷵻�<code>false</code>�� ���ǿ��ַ���Զ����
     * <code>true</code>.
     * </p>
     *
     * <pre>
     ...
     * ��ָ�����Ӵ�����һָ���Ӵ����ǡ�
     * <p>
     * ����ַ�Ϊ<code>null</code>���򷵻�<code>null</code>�� ��������ֵ��������
     * <code>0</code>��Խ�������ֵ�������ó��ַ�ĳ�����ͬ��ֵ��
     *
     * <pre>
     ...
     * @return ����ָ���ַ��β���ַ����ԭʼ�ִ�Ϊ<code>null</code>���򷵻�
     *         <code>null</code>
     */
