...
public class ArrayUtil {
     ...
     */
    public static Object[] defaultIfEmpty(Object[] array,
                                          @SuppressWarnings("rawtypes") Class defaultComponentType) {
    ...
    /**
     * ������ӳ��ɹ̶����ȵ�<code>List</code>�����ı����<code>List</code>
     * �е�ֵʱ�������е���ӦֵҲ���ı䡣
     * <p>
     * �����������Ϊ<code>null</code>���򷵻�<code>null</code>��
     * </p>
     * <p>
     * �÷����ڲ�����<code>java.util.Arrays.asList</code>
     * ������ص��б�Ϊָ�������ӳ�񣨹̶����ȣ���������ܺ��ڴ�ռ���ϱ�<code>toList</code>
     * �������š�
     * </p>
     * <p>
     * ��������������ڳ�ʼ�������磺
     ...
     * </p>
     * <p>
     * �÷������ص��б�Ϊָ������ĸ�������<code>java.util.Arrays.asList</code>
     * ������ص��б�Ϊָ�������ӳ�񣨹̶����ȣ���
     * </p>
     * <p>
     * ��������������ڳ�ʼ�������磺
     ...
     *                                                                       List singleList = ArrayUtil
     *                                                                                               .toList(&quot;hello&quot;); // ���ص���Ԫ�ص��б�[&quot;hello&quot;]
     * </pre>
     * 
     * </p>
     * 
    ...
    /**
     * ������ת����<code>Map</code>�������Ԫ�ر�����<code>Map.Entry</code>
     * ��Ԫ�ظ������2�������顣
     * <p>
     * �����������Ϊ<code>null</code>���򷵻�<code>null</code>��
     * </p>
     ...
     * @param array Ҫת��������
     * @return ��������map
     * @throws IllegalArgumentException �����һ��������Ԫ�ظ���С��2����
    ...
    /**
     * �ж����������Ƿ������ͬ�ĳ��ȡ��������Ϊ<code>null</code>�򱻿�������Ϊ
     * <code>0</code>��
     * 
     * @param array1 ����1
     * @param array2 ����2
     ...
     * @return ��Ԫ���������е���ţ��������Ϊ<code>null</code>��δ�ҵ����򷵻�
     *         <code>-1</code>��
     */
     ...
     * </p>
     * <p>
     * ��ʼ����С��<code>0</code>����<code>0</code>���������鳤�ȵ���ʼ�����򷵻�
     * <code>-1</code>��
     * </p>
     * 
     * @param array Ҫɨ�������
     ...
     * ������ת���������Ķ����ַ��ʾ��
     * <p>
     * ���������<code>null</code>�򷵻�<code>[]</code>��֧�ֶ�ά���顣 �������Ԫ��Ϊ
     * <code>null</code>������ʾ<code>&lt;null&gt;</code>��
     * 
     * <pre>
     ...
     * 
     * @param array Ҫת��������
     * @return �ַ��ʾ��<code>"[]"</code>��ʾ�������<code>null</code>
     */
     ...
     * ������ת���������Ķ����ַ��ʾ��
     * <p>
     * ���������<code>null</code>�򷵻�ָ���ַ�֧�ֶ�ά���顣 �������Ԫ��Ϊ
     * <code>null</code>������ʾ<code>&lt;null&gt;</code>��
     * 
     * <pre>
     ...
     * @return �ַ��ʾ���򷵻�ָ���ַ��ʾ<code>null</code>
     */
